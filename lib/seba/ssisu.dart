...
class Ssisu extends StatefulWidget {
  @override
  _SsisuState createState() => _SsisuState();
}

class _SsisuState extends State<Ssisu> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/seba/ssisu.json");
    setState(() {
