...
class Sneuro extends StatefulWidget {
  @override
  _SneuroState createState() => _SneuroState();
}

class _SneuroState extends State<Sneuro> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/seba/sneuro.json");
    setState(() {
