...
class Sgynoclogy extends StatefulWidget {
  @override
  _SgynoclogyState createState() => _SgynoclogyState();
}

class _SgynoclogyState extends State<Sgynoclogy> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/seba/sgynoclogy.json");
    setState(() {
