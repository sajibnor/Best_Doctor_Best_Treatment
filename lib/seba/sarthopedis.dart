...
class Sarthopedics extends StatefulWidget {
  @override
  _SarthopedicsState createState() => _SarthopedicsState();
}

class _SarthopedicsState extends State<Sarthopedics> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/seba/sarthopedics.json");
    setState(() {
