...
class Smedici extends StatefulWidget {
  @override
  _SmediciState createState() => _SmediciState();
}

class _SmediciState extends State<Smedici> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/seba/smedici.json");
    setState(() {
