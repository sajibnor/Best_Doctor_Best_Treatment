...
class Skidni extends StatefulWidget {
  @override
  _SkidniState createState() => _SkidniState();
}

class _SkidniState extends State<Skidni> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/seba/skidni.json");
    setState(() {
