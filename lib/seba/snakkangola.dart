...
class Snakkangola extends StatefulWidget {
  @override
  _SnakkangolaState createState() => _SnakkangolaState();
}

class _SnakkangolaState extends State<Snakkangola> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/seba/snakkangola.json");
    setState(() {
