...
class Scardology extends StatefulWidget {
  @override
  _ScardologyState createState() => _ScardologyState();
}

class _ScardologyState extends State<Scardology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/seba/scardology.json");
    setState(() {
