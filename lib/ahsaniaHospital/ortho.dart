...
class Orthopadics extends StatefulWidget {
  @override
  _OrthopadicsState createState() => _OrthopadicsState();
}

class _OrthopadicsState extends State<Orthopadics> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/ahsania/ortho.json");
    setState(() {
