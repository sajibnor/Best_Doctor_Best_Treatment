...
class Dgynology extends StatefulWidget {
  @override
  _DgynologyState createState() => _DgynologyState();
}

class _DgynologyState extends State<Dgynology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/dgynology.json");
    setState(() {
