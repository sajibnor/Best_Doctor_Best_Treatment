...
class Dnakkan extends StatefulWidget {
  @override
  _DnakkanState createState() => _DnakkanState();
}

class _DnakkanState extends State<Dnakkan> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/dnakkan.json");
    setState(() {
