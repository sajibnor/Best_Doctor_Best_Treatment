...
class Dcardiology extends StatefulWidget {
  @override
  _DcardiologyState createState() => _DcardiologyState();
}

class _DcardiologyState extends State<Dcardiology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/dcardiology.json");
    setState(() {
