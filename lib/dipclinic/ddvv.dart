...
class Ddvv extends StatefulWidget {
  @override
  _DdvvState createState() => _DdvvState();
}

class _DdvvState extends State<Ddvv> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/ddvv.json");
    setState(() {
