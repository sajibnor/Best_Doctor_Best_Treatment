...
class Dgastrology extends StatefulWidget {
  @override
  _DgastrologyState createState() => _DgastrologyState();
}

class _DgastrologyState extends State<Dgastrology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/dgastrology.json");
    setState(() {
