...
class Durolpogy extends StatefulWidget {
  @override
  _DurolpogyState createState() => _DurolpogyState();
}

class _DurolpogyState extends State<Durolpogy> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/durolpogy.json");
    setState(() {
