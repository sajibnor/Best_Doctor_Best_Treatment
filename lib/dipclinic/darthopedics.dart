...
class Darthopedics extends StatefulWidget {
  @override
  _DarthopedicsState createState() => _DarthopedicsState();
}

class _DarthopedicsState extends State<Darthopedics> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/darthopedics.json");
    setState(() {
