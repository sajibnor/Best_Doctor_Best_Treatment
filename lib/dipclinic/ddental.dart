...
class Ddental extends StatefulWidget {
  @override
  _DdentalState createState() => _DdentalState();
}

class _DdentalState extends State<Ddental> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/ddental.json");
    setState(() {
