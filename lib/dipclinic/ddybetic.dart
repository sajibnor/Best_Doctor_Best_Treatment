...
class Ddyetic extends StatefulWidget {
  @override
  _DdyeticState createState() => _DdyeticState();
}

class _DdyeticState extends State<Ddyetic> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipo/ddyetic.json");
    setState(() {
