...
class PsycologyDpt extends StatefulWidget {
  @override
  _PsycologyDptState createState() => _PsycologyDptState();
}

class _PsycologyDptState extends State<PsycologyDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularPhycology.json");
    setState(() {
