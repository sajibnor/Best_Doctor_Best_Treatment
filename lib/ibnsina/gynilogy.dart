...
class GynologyDpt extends StatefulWidget {
  @override
  _GynologyDptState createState() => _GynologyDptState();
}

class _GynologyDptState extends State<GynologyDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularGyni.json");
    setState(() {
