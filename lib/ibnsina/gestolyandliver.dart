...
class GestoLiverDpt extends StatefulWidget {
  @override
  _GestoLiverDptState createState() => _GestoLiverDptState();
}

class _GestoLiverDptState extends State<GestoLiverDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularGesto.json");
    setState(() {
