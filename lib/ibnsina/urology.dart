...
class UrologyDpt extends StatefulWidget {
  @override
  _UrologyDptState createState() => _UrologyDptState();
}

class _UrologyDptState extends State<UrologyDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularUrology.json");
    setState(() {
