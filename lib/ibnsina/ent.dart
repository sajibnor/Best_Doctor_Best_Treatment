...
class EntDpt extends StatefulWidget {
  @override
  _EntDptState createState() => _EntDptState();
}

class _EntDptState extends State<EntDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularEnt.json");
    setState(() {
