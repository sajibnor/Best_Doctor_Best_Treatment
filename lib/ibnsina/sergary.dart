...
class SergaryDpt extends StatefulWidget {
  @override
  _SergaryDptState createState() => _SergaryDptState();
}

class _SergaryDptState extends State<SergaryDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularSergery.json");
    setState(() {
