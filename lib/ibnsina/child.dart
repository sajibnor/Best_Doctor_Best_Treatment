...
class ChildDpt extends StatefulWidget {
  @override
  _ChildDptState createState() => _ChildDptState();
}

class _ChildDptState extends State<ChildDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularChild.json");
    setState(() {
