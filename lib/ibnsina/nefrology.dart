...
class NefrologyDpt extends StatefulWidget {
  @override
  _NefrologyDptState createState() => _NefrologyDptState();
}

class _NefrologyDptState extends State<NefrologyDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/PopularNeprology.json");
    setState(() {
