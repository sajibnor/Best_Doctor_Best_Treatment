...
class CardiologyDpt extends StatefulWidget {
  @override
  _CardiologyDptState createState() => _CardiologyDptState();
}

class _CardiologyDptState extends State<CardiologyDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularCardiology.json");
    setState(() {
