...
class OrthoDpt extends StatefulWidget {
  @override
  _OrthoDptState createState() => _OrthoDptState();
}

class _OrthoDptState extends State<OrthoDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularOrth.json");
    setState(() {
