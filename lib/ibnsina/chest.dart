...
class ChestDpt extends StatefulWidget {
  @override
  _ChestDptState createState() => _ChestDptState();
}

class _ChestDptState extends State<ChestDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/popularCest.json");
    setState(() {
