...
class SexDpt extends StatefulWidget {
  @override
  _SexDptState createState() => _SexDptState();
}

class _SexDptState extends State<SexDpt> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/ibnsina/populaSex.json");
    setState(() {
