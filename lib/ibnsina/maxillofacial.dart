...
class Maxillofacial extends StatefulWidget {
  @override
  _MaxillofacialState createState() => _MaxillofacialState();
}

class _MaxillofacialState extends State<Maxillofacial> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/ibnsina/mexi.json");
    setState(() {
