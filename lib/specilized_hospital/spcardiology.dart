...
class Spcardiology extends StatefulWidget {
  @override
  _SpcardiologyState createState() => _SpcardiologyState();
}

class _SpcardiologyState extends State<Spcardiology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spcardiology.json");
    setState(() {
