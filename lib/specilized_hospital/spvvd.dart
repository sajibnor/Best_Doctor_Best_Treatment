...
class Spvvd extends StatefulWidget {
  @override
  _SpvvdState createState() => _SpvvdState();
}

class _SpvvdState extends State<Spvvd> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/specilized/spvvd.json");
    setState(() {
