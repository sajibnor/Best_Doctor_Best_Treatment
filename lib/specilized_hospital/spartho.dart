...
class Sparthopedics extends StatefulWidget {
  @override
  _SparthopedicsState createState() => _SparthopedicsState();
}

class _SparthopedicsState extends State<Sparthopedics> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/sparthopedics.json");
    setState(() {
