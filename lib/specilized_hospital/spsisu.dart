...
class Spsisu extends StatefulWidget {
  @override
  _SpsisuState createState() => _SpsisuState();
}

class _SpsisuState extends State<Spsisu> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spsisu.json");
    setState(() {
