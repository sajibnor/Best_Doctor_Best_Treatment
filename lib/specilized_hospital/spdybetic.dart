...
class Spdybetic extends StatefulWidget {
  @override
  _SpdybeticState createState() => _SpdybeticState();
}

class _SpdybeticState extends State<Spdybetic> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spdybetic.json");
    setState(() {
