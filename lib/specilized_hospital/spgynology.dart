...
class Spgyni extends StatefulWidget {
  @override
  _SpgyniState createState() => _SpgyniState();
}

class _SpgyniState extends State<Spgyni> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/specilized/spgyni.json");
    setState(() {
