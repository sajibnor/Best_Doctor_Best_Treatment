...
class Spmedici extends StatefulWidget {
  @override
  _SpmediciState createState() => _SpmediciState();
}

class _SpmediciState extends State<Spmedici> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spmedici.json");
    setState(() {
