...
class Spnakkan extends StatefulWidget {
  @override
  _SpnakkanState createState() => _SpnakkanState();
}

class _SpnakkanState extends State<Spnakkan> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spnakkan.json");
    setState(() {
