...
class Spneuroserjery extends StatefulWidget {
  @override
  _SpneuroserjeryState createState() => _SpneuroserjeryState();
}

class _SpneuroserjeryState extends State<Spneuroserjery> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spneuroserjery.json");
    setState(() {
