...
class Spgserjon extends StatefulWidget {
  @override
  _SpgserjonState createState() => _SpgserjonState();
}

class _SpgserjonState extends State<Spgserjon> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spgserjon");
    setState(() {
