...
class Spneuromedi extends StatefulWidget {
  @override
  _SpneuromediState createState() => _SpneuromediState();
}

class _SpneuromediState extends State<Spneuromedi> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spneuromedi.json");
    setState(() {
