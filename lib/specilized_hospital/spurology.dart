...
class Spurology extends StatefulWidget {
  @override
  _SpurologyState createState() => _SpurologyState();
}

class _SpurologyState extends State<Spurology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/specilized/spurology.json");
    setState(() {
