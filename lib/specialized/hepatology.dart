...
class Hepatology extends StatefulWidget {
  @override
  _HepatologyState createState() => _HepatologyState();
}

class _HepatologyState extends State<Hepatology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/allspecialized/liver.json");
    setState(() {
