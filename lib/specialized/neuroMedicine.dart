...
class NeuroMedicine extends StatefulWidget {
  @override
  _NeuroMedicineState createState() => _NeuroMedicineState();
}

class _NeuroMedicineState extends State<NeuroMedicine> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle
        .loadString("lalldata/allspecialized/neoruMedicine.json");
    setState(() {
