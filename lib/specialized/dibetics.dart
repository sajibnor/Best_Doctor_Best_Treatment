...
class Dibetics extends StatefulWidget {
  @override
  _DibeticsState createState() => _DibeticsState();
}

class _DibeticsState extends State<Dibetics> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/allspecialized/dibetic.json");
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(
            "ডায়াবেটিস,থাইরয়েড & হরমোন  বিশেষজ্ঞ",
            style: TextStyle(
                fontSize: 15,
