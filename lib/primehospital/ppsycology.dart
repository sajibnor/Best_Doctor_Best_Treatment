...
class Ppsycology extends StatefulWidget {
  @override
  _PpsycologyState createState() => _PpsycologyState();
}

class _PpsycologyState extends State<Ppsycology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/savarprime/ppsycology.json");
    setState(() {
