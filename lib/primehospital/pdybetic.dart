...
class Pdyvetic extends StatefulWidget {
  @override
  _PdyveticState createState() => _PdyveticState();
}

class _PdyveticState extends State<Pdyvetic> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/savarprime/pdyvetic.json");
    setState(() {
