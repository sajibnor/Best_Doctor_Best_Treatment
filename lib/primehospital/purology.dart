...
class Pmutro extends StatefulWidget {
  @override
  _PmutroState createState() => _PmutroState();
}

class _PmutroState extends State<Pmutro> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/savarprime/pmutro.json");
    setState(() {
