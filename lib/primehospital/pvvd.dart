...
class Pvvd extends StatefulWidget {
  @override
  _PvvdState createState() => _PvvdState();
}

class _PvvdState extends State<Pvvd> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/savarprime/pvvd.json");
    setState(() {
