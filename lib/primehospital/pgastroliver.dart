...
class Pgestroliver extends StatefulWidget {
  @override
  _PgestroliverState createState() => _PgestroliverState();
}

class _PgestroliverState extends State<Pgestroliver> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/savarprime/pgestroliver.json");
    setState(() {
