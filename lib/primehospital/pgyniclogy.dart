...
class Pgyno extends StatefulWidget {
  @override
  _PgynoState createState() => _PgynoState();
}

class _PgynoState extends State<Pgyno> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/savarprime/pgyno.json");
    setState(() {
