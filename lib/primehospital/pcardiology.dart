...
class Pcardiology extends StatefulWidget {
  @override
  _PcardiologyState createState() => _PcardiologyState();
}

class _PcardiologyState extends State<Pcardiology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/savarprime/pcardiology.json");
    setState(() {
