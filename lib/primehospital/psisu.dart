...
class Psisu extends StatefulWidget {
  @override
  _PsisuState createState() => _PsisuState();
}

class _PsisuState extends State<Psisu> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/savarprime/psisu.json");
    setState(() {
