...
class Parthopedics extends StatefulWidget {
  @override
  _ParthopedicsState createState() => _ParthopedicsState();
}

class _ParthopedicsState extends State<Parthopedics> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/savarprime/parthopedics.json");
    setState(() {
