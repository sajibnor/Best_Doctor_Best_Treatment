...
class Pserjon extends StatefulWidget {
  @override
  _PserjonState createState() => _PserjonState();
}

class _PserjonState extends State<Pserjon> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/savarprime/pserjon.json");
    setState(() {
