...
class Pnakkangola extends StatefulWidget {
  @override
  _PnakkangolaState createState() => _PnakkangolaState();
}

class _PnakkangolaState extends State<Pnakkangola> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/savarprime/pnakkangola.json");
    setState(() {
