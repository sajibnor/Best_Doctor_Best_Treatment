...
class Crsisu extends StatefulWidget {
  @override
  _CrsisuState createState() => _CrsisuState();
}

class _CrsisuState extends State<Crsisu> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crsisu.json");
    setState(() {
