...
class Crgynoclogy extends StatefulWidget {
  @override
  _CrgynoclogyState createState() => _CrgynoclogyState();
}

class _CrgynoclogyState extends State<Crgynoclogy> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crgynoclogy.json");
    setState(() {
