...
class Crarthopedic extends StatefulWidget {
  @override
  _CrarthopedicState createState() => _CrarthopedicState();
}

class _CrarthopedicState extends State<Crarthopedic> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crarthopedic.json");
    setState(() {
