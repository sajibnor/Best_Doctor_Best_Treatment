...
class Crnakkan extends StatefulWidget {
  @override
  _CrnakkanState createState() => _CrnakkanState();
}

class _CrnakkanState extends State<Crnakkan> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crnakkan.json");
    setState(() {
