...
class Crcardiology extends StatefulWidget {
  @override
  _CrcardiologyState createState() => _CrcardiologyState();
}

class _CrcardiologyState extends State<Crcardiology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crcardiology.json");
    setState(() {
