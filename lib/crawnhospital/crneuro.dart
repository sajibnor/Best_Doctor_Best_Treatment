...
class Crneuro extends StatefulWidget {
  @override
  _CrneuroState createState() => _CrneuroState();
}

class _CrneuroState extends State<Crneuro> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crneuro.json");
    setState(() {
