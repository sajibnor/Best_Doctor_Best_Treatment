...
class Crgserjery extends StatefulWidget {
  @override
  _CrgserjeryState createState() => _CrgserjeryState();
}

class _CrgserjeryState extends State<Crgserjery> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crgserjery.json");
    setState(() {
