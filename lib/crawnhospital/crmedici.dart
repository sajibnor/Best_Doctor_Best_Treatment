...
class Crmedici extends StatefulWidget {
  @override
  _CrmediciState createState() => _CrmediciState();
}

class _CrmediciState extends State<Crmedici> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crmedici.json");
    setState(() {
