...
class Crdental extends StatefulWidget {
  @override
  _CrdentalState createState() => _CrdentalState();
}

class _CrdentalState extends State<Crdental> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crdental.json");
    setState(() {
