...
class Crvvd extends StatefulWidget {
  @override
  _CrvvdState createState() => _CrvvdState();
}

class _CrvvdState extends State<Crvvd> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/crawn/crvvd.json");
    setState(() {
