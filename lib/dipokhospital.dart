...
class DipokHospital extends StatefulWidget {
  @override
  _DipokHospitalState createState() => _DipokHospitalState();
}

class _DipokHospitalState extends State<DipokHospital> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/dipokhospital.json");
    setState(() {
