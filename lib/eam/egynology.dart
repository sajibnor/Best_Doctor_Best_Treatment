...
class Enamgynoclogy extends StatefulWidget {
  @override
  _EnamgynoclogyState createState() => _EnamgynoclogyState();
}

class _EnamgynoclogyState extends State<Enamgynoclogy> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enamgynoclogy.json");
    setState(() {
