...
class Enamlivarporipak extends StatefulWidget {
  @override
  _EnamlivarporipakState createState() => _EnamlivarporipakState();
}

class _EnamlivarporipakState extends State<Enamlivarporipak> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_livarporipak.json");
    setState(() {
