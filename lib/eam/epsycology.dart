...
class Psycology extends StatefulWidget {
  @override
  _PsycologyState createState() => _PsycologyState();
}

class _PsycologyState extends State<Psycology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_psycology.json");
    setState(() {
