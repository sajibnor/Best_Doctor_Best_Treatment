...
class Sisu extends StatefulWidget {
  @override
  _SisuState createState() => _SisuState();
}

class _SisuState extends State<Sisu> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/enam/enam_sisu.json");
    setState(() {
