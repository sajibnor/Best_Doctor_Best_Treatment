...
class EnamOncology extends StatefulWidget {
  @override
  _EnamOncologyState createState() => _EnamOncologyState();
}

class _EnamOncologyState extends State<EnamOncology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_oncology.json");
    setState(() {
