...
class Enephrology extends StatefulWidget {
  @override
  _EnephrologyState createState() => _EnephrologyState();
}

class _EnephrologyState extends State<Enephrology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_nephrology.json");
    setState(() {
