...
class EnamHistopathology extends StatefulWidget {
  @override
  _EnamHistopathologyState createState() => _EnamHistopathologyState();
}

class _EnamHistopathologyState extends State<EnamHistopathology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_histopathlogy.json");
    setState(() {
