...
class EnamWomen extends StatefulWidget {
  @override
  _EnamWomenState createState() => _EnamWomenState();
}

class _EnamWomenState extends State<EnamWomen> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_mohilaserjon.json");
    setState(() {
