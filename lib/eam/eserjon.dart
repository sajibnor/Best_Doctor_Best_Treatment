...
class Serjon extends StatefulWidget {
  @override
  _SerjonState createState() => _SerjonState();
}

class _SerjonState extends State<Serjon> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/enam/serjon.json");
    setState(() {
