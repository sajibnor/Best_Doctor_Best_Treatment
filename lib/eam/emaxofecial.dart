...
class Mexofecial extends StatefulWidget {
  @override
  _MexofecialState createState() => _MexofecialState();
}

class _MexofecialState extends State<Mexofecial> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_mexofecial.json");
    setState(() {
