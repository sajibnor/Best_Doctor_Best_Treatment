...
class EnamMedicine extends StatefulWidget {
  @override
  _EnamMedicineState createState() => _EnamMedicineState();
}

class _EnamMedicineState extends State<EnamMedicine> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enamMedicine.json");
    setState(() {
