...
class Enambokhkhobedi extends StatefulWidget {
  @override
  _EnambokhkhobediState createState() => _EnambokhkhobediState();
}

class _EnambokhkhobediState extends State<Enambokhkhobedi> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_bokhkhobedi.json");
    setState(() {
