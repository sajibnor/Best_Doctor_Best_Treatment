...
class Enamneuromedicine extends StatefulWidget {
  @override
  _EnamneuromedicineState createState() => _EnamneuromedicineState();
}

class _EnamneuromedicineState extends State<Enamneuromedicine> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enamneuromedicine.json");
    setState(() {
