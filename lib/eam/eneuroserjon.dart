...
class Enamneuroserjon extends StatefulWidget {
  @override
  _EnamneuroserjonState createState() => _EnamneuroserjonState();
}

class _EnamneuroserjonState extends State<Enamneuroserjon> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enamneuroserjon.json");
    setState(() {
