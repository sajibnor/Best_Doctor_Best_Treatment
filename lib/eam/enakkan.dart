...
class Enamnakkangola extends StatefulWidget {
  @override
  _EnamnakkangolaState createState() => _EnamnakkangolaState();
}

class _EnamnakkangolaState extends State<Enamnakkangola> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enamnak_kangola.json");
    setState(() {
