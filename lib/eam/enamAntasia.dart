...
class Anesthesiologist extends StatefulWidget {
  @override
  _AnesthesiologistState createState() => _AnesthesiologistState();
}

class _AnesthesiologistState extends State<Anesthesiologist> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_anestesia_icu.json");
    setState(() {
