...
class Enamcardology extends StatefulWidget {
  @override
  _EnamcardologyState createState() => _EnamcardologyState();
}

class _EnamcardologyState extends State<Enamcardology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enamcardology.json");
    setState(() {
