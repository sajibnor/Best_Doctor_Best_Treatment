...
class Vvd extends StatefulWidget {
  @override
  _VvdState createState() => _VvdState();
}

class _VvdState extends State<Vvd> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/enam/enam_vvd.json");
    setState(() {
