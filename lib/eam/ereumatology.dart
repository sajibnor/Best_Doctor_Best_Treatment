...
class Enamreumatology extends StatefulWidget {
  @override
  _EnamreumatologyState createState() => _EnamreumatologyState();
}

class _EnamreumatologyState extends State<Enamreumatology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/enam/enam_reumatology.json");
    setState(() {
