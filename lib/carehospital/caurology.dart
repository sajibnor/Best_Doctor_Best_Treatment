...
class Caurology extends StatefulWidget {
  @override
  _CaurologyState createState() => _CaurologyState();
}

class _CaurologyState extends State<Caurology> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/caurology.json");
    setState(() {
