...
class Cadental extends StatefulWidget {
  @override
  _CadentalState createState() => _CadentalState();
}

class _CadentalState extends State<Cadental> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/cadental.json");
    setState(() {
