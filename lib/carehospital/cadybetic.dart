...
class Cadybetic extends StatefulWidget {
  @override
  _CadybeticState createState() => _CadybeticState();
}

class _CadybeticState extends State<Cadybetic> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/cadybetic.json");
    setState(() {
