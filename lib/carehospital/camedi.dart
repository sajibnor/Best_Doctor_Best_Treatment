...
class Camedi extends StatefulWidget {
  @override
  _CamediState createState() => _CamediState();
}

class _CamediState extends State<Camedi> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/camedi.json");
    setState(() {
