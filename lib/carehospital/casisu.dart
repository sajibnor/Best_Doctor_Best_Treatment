...
class Casisu extends StatefulWidget {
  @override
  _CasisuState createState() => _CasisuState();
}

class _CasisuState extends State<Casisu> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/casisu.json");
    setState(() {
