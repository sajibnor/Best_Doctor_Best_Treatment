...
class Capusti extends StatefulWidget {
  @override
  _CapustiState createState() => _CapustiState();
}

class _CapustiState extends State<Capusti> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/capusti.json");
    setState(() {
