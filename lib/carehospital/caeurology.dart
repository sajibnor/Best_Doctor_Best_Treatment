...
class Caneurology extends StatefulWidget {
  @override
  _CaneurologyState createState() => _CaneurologyState();
}

class _CaneurologyState extends State<Caneurology> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/care/caneurology.json");
    setState(() {
