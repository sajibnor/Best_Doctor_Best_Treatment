...
class Canakkan extends StatefulWidget {
  @override
  _CanakkanState createState() => _CanakkanState();
}

class _CanakkanState extends State<Canakkan> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/canakkan.json");
    setState(() {
