...
class Cagynoclogy extends StatefulWidget {
  @override
  _CagynoclogyState createState() => _CagynoclogyState();
}

class _CagynoclogyState extends State<Cagynoclogy> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/cagynoclogy.json");
    setState(() {
