...
class Casergery extends StatefulWidget {
  @override
  _CasergeryState createState() => _CasergeryState();
}

class _CasergeryState extends State<Casergery> {
  var data;

  Future loadjsondata() async {
    var response = await rootBundle.loadString("lalldata/care/casergery.json");
    setState(() {
