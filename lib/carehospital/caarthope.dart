...
class Caarthopedics extends StatefulWidget {
  @override
  _CaarthopedicsState createState() => _CaarthopedicsState();
}

class _CaarthopedicsState extends State<Caarthopedics> {
  var data;

  Future loadjsondata() async {
    var response =
        await rootBundle.loadString("lalldata/care/caarthopedics.json");
    setState(() {
